...
var PacManAudioEngine = (function () {
    ...
    var tracks = {
        ...
        // EAT BEER: "Gluck Gluck" – kurzes blubberndes Bier-Trinkgeräusch
        "gluck": function () {
            var c = ensureCtx(); if (!c) return [];
            var all = [];
            var t = c.currentTime;
            // Erste Silbe "Gluck": kurzer Abwärtssweep
            var o1 = c.createOscillator();
            var g1 = c.createGain();
            o1.type = "sine";
            o1.frequency.setValueAtTime(520, t);
            o1.frequency.exponentialRampToValueAtTime(200, t + 0.065);
            g1.gain.setValueAtTime(0.22, t);
            g1.gain.linearRampToValueAtTime(0.001, t + 0.075);
            o1.connect(g1); g1.connect(c.destination);
            o1.start(t); o1.stop(t + 0.08);
            all.push(o1, g1);
            // Zweite Silbe "Gluck": leicht versetzt, tiefer
            var o2 = c.createOscillator();
            var g2 = c.createGain();
            o2.type = "sine";
            o2.frequency.setValueAtTime(420, t + 0.09);
            o2.frequency.exponentialRampToValueAtTime(160, t + 0.155);
            g2.gain.setValueAtTime(0.001, t);
            g2.gain.setValueAtTime(0.18, t + 0.09);
            g2.gain.linearRampToValueAtTime(0.001, t + 0.165);
            o2.connect(g2); g2.connect(c.destination);
